...
import { Link } from "react-router-dom"; // Change from <a> to <Link>
...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-40 bg-background/90 backdrop-blur-md border-b border-foreground/5">
